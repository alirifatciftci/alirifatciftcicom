...
<head runat="server">
 ...
 ================================================== -->
    ...
    <!-- Site Favicon
 ================================================== -->
    <link rel="shortcut icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><text y='90' font-size='90'>🖥️</text></svg>" sizes="any">
            ...
            <div class="max-lg:px-4">
                ...
                <div class="fixed top-0 left-0 right-0 z-50 flex items-center justify-between p-2 px-3 bg-white/10 mobile-menu-bar sm:px-6 backdrop-blur-md xl:hidden">
                    <div class="text-lg font-medium name">
                        <a href="Default.aspx" class="flex items-center gap-2 text-black dark:text-white">
                            <img src="assets/img/site-logo.svg" alt="Minfo">
                            <span>Minfo</span>
                        </a>
                    </div>
        ...
        <div class="minfo__nav__wrapper bg-snowWhite dark:bg-power__black max-xl:hidden fixed top-1/2 -translate-y-1/2 right-4 2xl:right-14 z-999 flex items-center flex-col gap-4 border border-platinum dark:border-metalBlack rounded-4xl px-2.5 py-4">
            ...
            <div class="relative share group">
                ...
                <div class="absolute bottom-0 flex items-center invisible px-5 py-6 space-x-3 transition-all duration-300 -translate-y-1/2 opacity-0 social-icons top-1/2 bg-white dark:bg-nightBlack rounded-4xl right-6 group-hover:opacity-100 group-hover:visible group-hover:right-10 -z-1 *:flex *:transition *:duration-200">
                    ...
                    <a href="https://www.linkedin.com/in/alirifatciftci" class="hover:text-theme" title="Share with Linkedin" target="_blank" rel="noopener noreferrer">
                        <i class="fab fa-linkedin-in"></i>
                    </a>
                    <a href="https://www.instagram.com/olddra" class="hover:text-theme" title="Share with Instagram" target="_blank" rel="noopener noreferrer">
                        <i class="fab fa-instagram"></i>
                    </a>

                    <a href="https://wa.me/905551933465" class="hover:text-theme" title="Share with WhatsApp" target="_blank" rel="noopener noreferrer">
                ...
                <div class="hero-section px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
                    ...
                    <div class="items-center gap-6 hero-content md:flex xl:gap-10">
                        <div class="text-content pt-7 lg:pt-8 max-lg:max-w-[30rem]">
                            <h1 class="text-[32px] lg:text-5xl xl:text-4xl 2xl:text-5xl font-semibold text-black dark:text-white leading-1.27 lg:leading-1.27 xl:leading-1.27 2xl:leading-1.27 mb-4 lg:mb-5">Merhaba ben
                                <br>
                                <span class="text-theme">Ali Rıfat ÇİFTÇİ</span>
                            </h1>
                            <p>
            ...
            <div data-scroll-index="6" id="blog">
                ...
                <div class="blog-section px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
                    ...
                    <div class="mt-5 mb-8 md:my-10 section-title">
                        <h2 class="title text-[32px] md:text-4xl lg:text-5xl font-extralight text-black dark:text-white leading-1.27">Son <span class="font-semibold text-theme">Projelerim</span>
                        </h2>
                        <p class="w-full mt-4 md:mt-6 subtitle text-justify">
                            Projelerime göz atarak, üzerinde çalıştığım işleri ve yeteneklerimi daha yakından inceleyebilirsiniz.
    <br>
                            You can take a closer look at the projects I've worked on and explore my skills in more detail.
                        </p>
                    ...
                    <div class="blog-list md:space-y-7.5 space-y-5 *:grid md:*:gap-2 *:grid-cols-12 *:overflow-hidden *:bg-flashWhite dark:*:bg-metalBlack *:items-center *:rounded-2xl *:p-3.5">
                        <div class="article group">
                            <div class="thumbnail overflow-hidden flex col-span-12 sm:col-span-6 md:col-span-5">
                                <a href="https://github.com/alirifatciftci/Suloink-Tattoo.git" target="_blank" class="block w-full overflow-hidden rounded-xl shadow-lg">
                                    <img
                                        src="assets/img/tattoos2.png"
                                        class="object-cover object-center w-full h-[300px] transition-all duration-300 ease-in-out group-hover:scale-105"
                                        alt="Post Title">
                                </a>
                            </div>
                            ...
                            <div class="post-content relative px-3 pt-6 pb-2 md:p-5 flex flex-col col-span-12 sm:col-span-6 md:col-span-7">
                                <div class="flex items-center gap-5">
                                    <div class="text-sm font-medium tags">
                                        <a href="#" class="transition-colors hover:text-theme">Web Site</a>,
                    <span class="post_date">03 Oct 2024</span>
                                    </div>
                                </div>
                                <div class="post-title mt-3 md:mt-4.5 mb-6 md:mb-8">
                                    <a href="https://github.com/alirifatciftci/Suloink-Tattoo.git" target="_blank"
                                        class="text-xl font-semibold leading-normal text-black dark:text-white transition-colors line-clamp-2 2xl:text-2xl 2xl:leading-normal hover:text-theme">SuloInk Tattoo için web sitesi geliştirildi. MVC Projesi</a>
                                </div>
                                <div class="read-details">
                                    <a href="https://github.com/alirifatciftci/Suloink-Tattoo.git" target="_blank"
                                        class="inline-flex items-center gap-2 border border-theme text-theme text-sm py-3.5 px-6 rounded-3xl leading-none transition-all duration-300 hover:bg-themeHover hover:border-themeHover dark:font-medium hover:text-white">Daha fazlası için tıklayınız</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="article group">
                            <div class="thumbnail overflow-hidden flex col-span-12 sm:col-span-6 md:col-span-5">
                                <a href="https://github.com/alirifatciftci/Ogrenci-Not-Kayit-Sistemi.git" target="_blank" class="block w-full overflow-hidden rounded-xl shadow-lg">
                                    <img
                                        src="assets/img/ogrenc.png"
                                        class="object-cover object-center w-full h-[300px] transition-all duration-300 ease-in-out group-hover:scale-105"
                                        alt="Post Title">
                                </a>
                            </div>
                            <div class="post-content relative px-3 pt-6 pb-2 md:p-5 flex flex-col col-span-12 sm:col-span-6 md:col-span-7">
                                <div class="flex items-center gap-5">
                                    <div class="text-sm font-medium tags">
                                        <a href="#" class="transition-colors hover:text-theme">Not Projesi</a>,
                    <span class="post_date">23 Oct 2024</span>
                                    </div>
                                </div>
                                <div class="post-title mt-3 md:mt-4.5 mb-6 md:mb-8">
                                    <a href="https://github.com/alirifatciftci/Ogrenci-Not-Kayit-Sistemi.git" target="_blank" class="text-xl font-semibold leading-normal text-black dark:text-white transition-colors line-clamp-2 2xl:text-2xl 2xl:leading-normal hover:text-theme">Öğrenci not kayıt sistemi</a>
                                </div>
                                <div class="read-details">
                                    <a href="https://github.com/alirifatciftci/Ogrenci-Not-Kayit-Sistemi.git" target="_blank" class="inline-flex items-center gap-2 border border-theme text-theme text-sm py-3.5 px-6 rounded-3xl leading-none transition-all duration-300 hover:bg-themeHover hover:border-themeHover dark:font-medium hover:text-white">Daha fazlası için tıklayınız</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="article group">
                            <div class="thumbnail overflow-hidden flex col-span-12 sm:col-span-6 md:col-span-5">
                                <a href="https://github.com/alirifatciftci/Doviz-Ofisi.git" target="_blank" class="block w-full overflow-hidden rounded-xl shadow-lg">
                                    <img
                                        src="assets/img/dovz.png"
                                        class="object-cover object-center w-full h-[300px] transition-all duration-300 ease-in-out group-hover:scale-105"
                                        alt="Post Title">
                                </a>
                            </div>
                            <div class="post-content relative px-3 pt-6 pb-2 md:p-5 flex flex-col col-span-12 sm:col-span-6 md:col-span-7">
                                <div class="flex items-center gap-5">
                                    <div class="text-sm font-medium tags">
                                        <a href="#" class="transition-colors hover:text-theme">Döviz Projesi</a>,
                    <span class="post_date">01 Dec 2024</span>
                                    </div>
                                </div>
                                <div class="post-title mt-3 md:mt-4.5 mb-6 md:mb-8">
                                    <a href="https://github.com/alirifatciftci/Doviz-Ofisi.git" target="_blank" class="text-xl font-semibold leading-normal text-black dark:text-white transition-colors line-clamp-2 2xl:text-2xl 2xl:leading-normal hover:text-theme">Merkez bankası kuru ile döviz hesabı</a>
                                </div>
                                <div class="read-details">
                                    <a href="https://github.com/alirifatciftci/Doviz-Ofisi.git" target="_blank" class="inline-flex items-center gap-2 border border-theme text-theme text-sm py-3.5 px-6 rounded-3xl leading-none transition-all duration-300 hover:bg-themeHover hover:border-themeHover dark:font-medium hover:text-white">Daha fazlası için tıklayınız</a>
                                </div>
                            </div>
                        </div>
                    </div>
                   <div class="mt-10 text-center more-blogs md:mt-13">
                        <a href="https://github.com/alirifatciftci" target="_blank"
